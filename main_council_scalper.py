...
CONFIG_KEYS = ["2025/cpu", "2024/cpu", "2023/cpu", "2022/cpu",
               "2021/cpu", "2020/cpu",
               "2025/integrated circuit", "2024/integrated circuit", "2023/integrated circuit", "2022/integrated circuit",
               "2021/integrated circuit", "2020/integrated circuit"]
...
if __name__ == "__main__":
    ...
    try:
        ...
        for config_key in CONFIG_KEYS:
            ...
            if active_config:
                if is_retry_mode:
                    print(f"\n\n--- Running RETRY mode for {active_config['name']} ({config_key}) ---")
                    run_scraper(active_config, retry_mode=True)
                else:
                    print(f"\n\n--- Running NORMAL mode for {active_config['name']} ({config_key}) ---")
